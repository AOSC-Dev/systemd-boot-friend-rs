...
complete -c systemd-boot-friend -n "__fish_use_subcommand" -f -a "install-kernel" -d 'Install the kernel specified'
complete -c systemd-boot-friend -n "__fish_use_subcommand" -f -a "remove-kernel" -d 'Remove the kernel specified'
